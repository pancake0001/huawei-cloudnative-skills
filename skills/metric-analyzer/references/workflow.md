...
- For Node issues: suggest `node-failure-diagnoser`
- For capacity planning: suggest `capacity-trend-forecaster`
- For cost optimization: suggest `cost-optimization-advisor`