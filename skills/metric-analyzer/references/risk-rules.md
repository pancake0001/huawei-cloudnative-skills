...
- Do not make automatic scaling or remediation decisions based solely on metric analysis. Forward to `auto-remediation-runner` only if explicitly requested and validated.
