...
Use `kubectl cce` as the primary Kubernetes access path. Do not generate or patch kubeconfig, call the Kubernetes SDK, or fall back to SDK dispatcher actions
for Kubernetes evidence.
