...
- Do not use Python SDK dispatcher commands, `scripts/huawei-cloud.py`, `skill action=exec`, `huawei_change_impact_*`, `huawei_query_*`, `huawei_get_cce_*`, kubeconfig generation, direct IAM curl flows, or Huawei Cloud SDK imports.
