...
7. Normalize each domain finding into a root cause candidate with domain, title, supporting evidence, counter-evidence, data gaps, affected scope, confidence, and next verification.
