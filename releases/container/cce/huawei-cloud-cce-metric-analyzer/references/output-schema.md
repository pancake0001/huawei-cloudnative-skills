...
The aggregation result also includes `component_metrics` for CoreDNS, nginx-ingress, and autoscaler. Component outputs are compact summaries with verbose
`time_series` arrays removed.
