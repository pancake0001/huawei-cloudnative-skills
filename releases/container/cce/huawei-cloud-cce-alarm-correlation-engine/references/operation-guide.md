...
| `bind_notification_rule_id`       | Yes for batch configure            | Existing AOM notification rule ID/name. If missing, call `huawei_list_aom_notification_action_rules`, show candidates, and wait for explicit user confirmation. |
