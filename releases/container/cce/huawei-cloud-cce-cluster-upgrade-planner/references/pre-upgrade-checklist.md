...
- **Kubelet label incompatibility**: v1.19 apiserver rejects v1.15 kubelet labels (`failure-domain.beta.kubernetes.io/is-baremetal`,
  `kubernetes.io/availablezone`). Nodes may become NotReady.
