...
2. If the root cause is that a Deployment's new version is unavailable due to startup command, image, probe, or CrashLoop, prefer `rollback_previous_revision`
   strategy.
