...
Services provide stable internal networking for pod groups. Ingress exposes HTTP/HTTPS routes from outside the cluster to Services, with host and path-based
routing.
